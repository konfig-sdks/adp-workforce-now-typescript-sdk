...
/**
 * This class provides a wrapper for network errors when making requests to ADP APIs
 */
export class AdpWorkforceNowError extends Error {
  /**
   * The response body
   */
  ...
  constructor(axiosError: AxiosError, responseBody: unknown) {
    ...
    this.name = "AdpWorkforceNowError";
